...
const VOWEL_DATA = [
  ...
  { phon: 'ʊ',   mn: '呜呜水坑(污污水坑)',   suffix: '呜呜呜',         word: 'book',   audio: 'audio/vowel-u-short.mp3', videoPhon: 'aʊ' },
  ...
  { phon: 'ɜː',  mn: '尖叫扎人(尖角扎人)',   suffix: '啊啊啊',         word: 'bird',   audio: 'audio/vowel-er-long.mp3', videoPhon: 'æ' },
  { phon: 'ə',   mn: '小鹅倒立(小鹅倒立胃)', suffix: '鹅鹅鹅',         word: 'about',  audio: 'audio/vowel-schwa-short.mp3', videoPhon: 'əː' },
  // --- 双元音 8 ---
...
const CONSONANT_DATA = [
  ...
  { phon: 'tr',  mn: '轻轻戳动(轻轻戳洞)',   suffix: 'ch ch ch',       word: 'tree',   audio: 'audio/consonant-tr.mp3' },
  { phon: 'dr',  mn: '小鸟捉虫',   suffix: 'zhuo zhuo zhuo', word: 'dream',  audio: 'audio/consonant-dr.mp3' },
  { phon: 'ts',  mn: '龇牙咧嘴(呲牙咧嘴)',   suffix: 'z z z',          word: 'cats',   audio: 'audio/consonant-ts.mp3' },
  ...
  { phon: 'r',   mn: '舌根后缩(卷起舌尖)',   suffix: 'r r r',          word: 'red',    audio: WIKI_AUDIO_BASE + 'Alveolar_approximant.ogg' },
  { phon: 'j',   mn: '卷起舌尖(一位爷爷)',   suffix: 'y y y',          word: 'yes',    audio: WIKI_AUDIO_BASE + 'Palatal_approximant.ogg' },
  { phon: 'w',   mn: '一位爷爷(学生是我)',   suffix: 'w w w',          word: 'we',     audio: WIKI_AUDIO_BASE + 'Voiced_labio-velar_approximant.ogg' }
];
